...
function ChooseLaneCards() {
  return (
    <div className="relative mx-auto grid w-full max-w-6xl grid-cols-1 gap-6 sm:gap-8 md:grid-cols-3">
      {CHOOSE_LANE_CARDS.map((item) => {
        const Icon = item.icon;
        return (
          <Link
            key={item.title}
            to="/auth?mode=signup"
            className="group flex min-h-[280px] flex-col overflow-hidden rounded-[1.35rem] border border-border/60 bg-card shadow-md hover:border-primary/25 hover:shadow-lg"
          >
            <div className={cn("relative h-32 overflow-hidden sm:h-36", item.grad)}>
              <div className="absolute inset-0 bg-[url('/hero-visual.png')] bg-cover bg-center mix-blend-overlay opacity-30" />
              <div className="absolute inset-0 bg-gradient-to-t from-card via-card/20 to-transparent" />
              <div className="absolute bottom-3 left-4 flex h-12 w-12 items-center justify-center rounded-2xl border border-border/50 bg-background/90 shadow-md">
...
export default function LandingPage() {
  ...
  return (
    <div className="min-h-screen bg-background text-foreground flex flex-col relative overflow-x-hidden">
      <header className="fixed inset-x-0 top-0 z-50 overflow-visible border-b border-border/40 bg-background/85 backdrop-blur-xl supports-[backdrop-filter]:bg-background/75">
      ...
      <main className="relative z-10 flex-1 pt-14 sm:pt-16">
        {/* Hero — full first viewport below fixed header */}
        <section className="relative flex h-[calc(100dvh-3.5rem)] max-h-[calc(100dvh-3.5rem)] min-h-0 flex-col overflow-x-hidden overflow-y-visible mesh-marketing landing-aurora text-foreground sm:h-[calc(100dvh-4rem)] sm:max-h-[calc(100dvh-4rem)]">
          <LandingBackdrop />
          <HeroSplineRobot />

          <div className="relative z-10 flex min-h-0 flex-1 flex-col justify-start px-0 pb-2 pt-20 max-sm:pb-3 sm:justify-center sm:pt-0 sm:py-3 md:py-4 overflow-x-hidden overflow-y-visible">
            <div className="relative z-30 mx-auto flex w-full min-h-0 max-w-7xl flex-col px-4 max-sm:min-h-0 max-sm:flex-1 sm:px-8">
              ...
              <div className="mt-0 grid min-h-0 gap-y-5 gap-x-0 max-sm:flex max-sm:min-h-0 max-sm:flex-1 max-sm:flex-col sm:gap-y-6">
                <div className="min-h-0 max-w-full text-left max-sm:flex max-sm:min-h-0 max-sm:flex-1 max-sm:flex-col max-sm:justify-between xl:max-w-[min(100%,42rem)]">
                  ...
                  <h1 className="font-outfit text-[1.65rem] font-semibold leading-[1.08] tracking-[-0.045em] text-foreground sm:text-4xl md:text-5xl lg:text-[2.75rem] lg:leading-[1.06] xl:text-[3.1rem]">
                  ...
                  <p className="mt-5 max-w-xl font-mono text-[10px] font-medium uppercase leading-relaxed tracking-[0.18em] text-muted-foreground max-sm:mt-0 sm:mt-6 sm:text-[11px] sm:tracking-[0.2em] md:mt-7 md:text-xs md:tracking-[0.22em] lg:mt-9 xl:mt-10">
                  ...
                  <div className="mt-5 flex min-h-0 flex-col gap-5 max-sm:mt-0 sm:mt-6 sm:gap-6 md:mt-7 md:gap-6 lg:mt-9 lg:gap-7 xl:mt-10 xl:gap-8">
                    <div className="grid w-full grid-cols-3 gap-1.5 sm:gap-2 md:gap-3">
                      {[
                        ...
                        <span
                          key={label}
                          className="flex min-h-[2.75rem] min-w-0 flex-col items-center justify-center gap-1 rounded-xl border border-border/55 bg-gradient-to-br from-muted/45 via-muted/25 to-muted/40 px-1 py-2 text-center shadow-sm backdrop-blur-[2px] sm:min-h-0 sm:flex-row sm:items-center sm:justify-center sm:gap-2 sm:rounded-2xl sm:px-3 sm:py-2.5 sm:text-left md:gap-2.5 md:px-4 md:py-3"
                        >
                          <span
                            className={cn(
                  ...
                  <Link
                    ...
                    className={cn(
                      ...
                      "hover:shadow-[0_16px_48px_-8px_hsl(var(--primary)/0.6),inset_0_1px_0_0_rgba(255,255,255,0.28)]",
                  ...
                  >
                    ...
                    <span className="relative z-10 flex w-full items-center gap-2 px-3 py-2.5">
                      ...
                      <span className="flex h-7 w-7 shrink-0 items-center justify-center rounded-full border border-white/25 bg-white/10">
                  ...
                  <div className="hidden grid-cols-1 gap-2 sm:mt-6 sm:grid sm:grid-cols-2 sm:gap-2.5 md:mt-7 lg:mt-9 xl:mt-10">
                    ...
                    >
                      ...
                      <span className="relative z-10 flex w-full items-center gap-1.5 px-2 py-1.5 sm:gap-2 sm:px-2.5 sm:py-2 md:px-3">
                        ...
                        <span className="flex h-6 w-6 shrink-0 items-center justify-center rounded-full border border-white/25 bg-white/10 sm:h-7 sm:w-7">
        ...
        {/* Marquee — sectors ribbon (CSS animate-marquee in tailwind.config) */}
