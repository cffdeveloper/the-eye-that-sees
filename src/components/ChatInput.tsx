...
export function ChatInput({
  ...
  useEffect(() => {
    ...
    window.addEventListener("infinitygap-quick-prompt", handler);
    return () => window.removeEventListener("infinitygap-quick-prompt", handler);
  }, [onSend]);
    ...
    <form onSubmit={submit} className="relative">
      <div className="glass-panel-strong glow-border-strong p-2.5 flex items-end gap-2">
        <textarea
          ...
          placeholder="Ask Infinitygap anything..."
          rows={1}
