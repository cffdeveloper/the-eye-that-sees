...
export function IntelWorkflowGuide({ className }: { className?: string }) {
  return (
    ...
    >
      <p className="text-[10px] font-bold uppercase tracking-widest text-primary mb-1.5">How Intel GoldMine fits your day</p>
      ...
      <ol className="list-decimal list-inside space-y-2.5 text-sm text-muted-foreground leading-relaxed [&>li]:marker:text-primary [&>li]:marker:font-bold">
        <li>
          <span className="text-foreground font-semibold">Pick a sector</span> — each industry card explains what Intel GoldMine watches for that vertical, then opens a full brief plus news and social intel tuned to your geography.
        </li>
        <li>
